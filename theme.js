...
(function AmbientGlass() {
  ...
  function renderLibraryGrid() {
    ...
    if (_currentType === 'playlists') {
      ...
      createCover.innerHTML = `
        <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: #00a8cc;">
  ...
  function triggerStartupAnimation() {
    ...
    s.innerHTML = `
      <style>
        ...
        .ag-splash-glow { position: absolute; width: 600px; height: 600px; background: radial-gradient(circle, rgba(30, 211, 243, 0.4) 0%, rgba(79,142,235,0.1) 40%, transparent 70%); filter: blur(60px); animation: ag-glow-cinematic 8s infinite alternate ease-in-out; pointer-events: none; }
        .ag-splash-content { position: relative; z-index: 2; display: flex; flex-direction: column; align-items: center; gap: 20px; }
        .ag-splash-title { color: #fff; font-size: 24px; font-weight: 200; letter-spacing: 8px; text-transform: uppercase; opacity: 0.8; margin-top: 10px; background: linear-gradient(to right, #fff, #a0e4ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
      ...
      <div style="position: absolute; bottom: 20px; left: 20px; color: #fff; font-size: 10px; letter-spacing: 1px; font-family: monospace;">github.com/Takayashii</div>
    `;
...

    {
      ...
      style.textContent = `
        ...
        .ag-fixed-hitbox:hover {
          background: rgba(255, 255, 255, 0.15) !important;
          border-color: rgba(255, 255, 255, 0.2) !important;
          box-shadow: 0 0 20px rgba(95, 190, 219, 0.3);
        }
  ...
  function showOnboarding(force = false) {
    ...
    overlay.innerHTML = `
      ...
      <div class="ag-onboarding-card">
        ...
        <div class="ag-onboarding-mark" aria-hidden="true">S+</div>
  ...
  function applyCustomColors() {
    ...
    const nowGlowGlass = 'linear-gradient(90deg, var(--ag-surface-tint-soft, rgba(95, 190, 219, 0.22)), color-mix(in srgb, var(--ag-s2, #4f8edb) 18%, transparent))';
    ...
    s.textContent = `
      ...
      #ag-jam-floating-pill {
        ...
        background: rgba(95, 184, 219, 0.72) !important;
        color: #fff !important;
        font-weight: 800 !important;
        font-size: 12px !important;
        box-shadow: 0 10px 30px rgba(0,0,0,0.35), 0 0 18px rgba(95, 194, 219, 0.28) !important;
      }
