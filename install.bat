...
echo =========================================
echo SpotifyPlus Installer (Spicetify)
echo =========================================
echo.
...
curl -sL https://raw.githubusercontent.com/Takayashii/SpotifyPlus/refs/heads/main/user.css -o "%THEME_DIR%\user.css"
curl -sL https://raw.githubusercontent.com/Takayashii/SpotifyPlus/refs/heads/main/color.ini -o "%THEME_DIR%\color.ini"
curl -sL https://raw.githubusercontent.com/Takayashii/SpotifyPlus/refs/heads/main/theme.js -o "%EXT_DIR%\theme.js"

echo [3/4] Configuring Spicetify...
call spicetify config current_theme SpotifyPlus
